    ...
    loadComponents().then(function () {
      ...
      if (fxGrid && fxChips.length) {
        ...
        var UNI_DATA = {
          ...
          'addiction-mental-health|Colleges across Canada': { full: 'Colleges across Canada', location: 'Canada', blurb: 'We match you to a college that fits your goals, budget and location. A Community Support Worker specialization focused on supporting people living with addiction and mental health challenges, through harm reduction, crisis response and case management.', programs: [{ name: 'Addiction & Mental Health (Community Support Worker specialization)', desc: 'Practical training in mental health and addiction fundamentals, harm reduction, trauma-informed and crisis support, and community resources, preparing you for frontline roles across mental health and addiction services.' }] },
