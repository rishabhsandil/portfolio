      ...
      formInstance.submit(function () {
        ...
        $('#rv-message').slideUp(750, function () {
          ...
          $.post(
            action,
            {
              // Change keys to match PHP expectation
              'rv-name': $('#rv-name').val(),
              'rv-email': $('#rv-email').val(),
              'rv-phone': $('#rv-phone').val(),
              'rv-guests': $('#rv-guests').val(),
              'rv-date': $('#rv-date').val(),
              'rv-time': $('#rv-time').val(),
            },
            function (data) {
        ...
        $('#message').slideUp(750, function () {
          ...
          $.post(
            ...
            function (data) {
              ...
              // Show error if server returns 500 or empty response
